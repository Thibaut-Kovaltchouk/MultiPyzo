...
def introduce_renamed_methods_qheaderview(QHeaderView):
    ...
    def isClickable(self):
        warnings.warn(
            "isClickable is only available in Qt4. Use " "sectionsClickable instead.",
            stacklevel=2,
        )
        return _isClickable(self)
    ...
    def isMovable(self):
        warnings.warn(
            "isMovable is only available in Qt4. Use " "sectionsMovable instead.",
            stacklevel=2,
        )
        return _isMovable(self)
    ...
    def resizeMode(self, logicalIndex):
        warnings.warn(
            "resizeMode is only available in Qt4. Use " "sectionResizeMode instead.",
            stacklevel=2,
        )
        return _resizeMode(self, logicalIndex)
